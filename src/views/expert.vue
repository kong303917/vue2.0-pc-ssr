...
export default {
  ...
  , created() {
    this.$store.dispatch('getTechnicianList',{'offset':0,'limit':8})
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      this.$store.dispatch('getTechnicianList', {offset, limit})
  ...
  computed: {
    ...
    // })
    ...mapGetters({
      technicianLists: 'getTechnicianList',
      currentPage: 'setCurrentPage'
    }),
    ...mapState({
      totalSize: state => state.list.totalSize,
      tabActiveIndex: state => state.list.tabActiveIndex,
